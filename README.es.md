...
Sorokeep entrega alertas a través de múltiples canales: **webhooks**, **Slack**, **Discord**, **Telegram** y **PagerDuty**. Cada alerta incluye un nivel de severidad y un contexto rico sobre la entrada afectada. Sorokeep utiliza una arquitectura de detección y despacho robusta y desacoplada con una cola respaldada por base de datos.
...
El correo electrónico aún no está implementado. La CLI rechazará `--type email` con un mensaje de error claro. Webhook y Slack son los canales admitidos hoy en día.
