...
- Prometheus `/metrics` endpoint for teams with existing observability stacks — an [example Grafana dashboard](devops/grafana/sorokeep-dashboard.json) is included
