...
import { watchContract, runMonitorCycle, inspectContract, parseSacBalance, buildSacBalanceKeyXdr, formatTokenBalance, registerAlertChannel } from "../src/lib.js";
...
describe("sorokeep library entry point", () => {
    ...
    it("exports registerAlertChannel as a function", () => {
        expect(typeof registerAlertChannel).toBe("function");
    });
});
