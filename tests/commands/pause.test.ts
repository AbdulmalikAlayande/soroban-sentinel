...
describe("Pause and Resume Commands", () => {
    ...
    it("pause exits with 1 if contract is not found", async () => {
        ...
        await pauseActionFn("CAAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQC526");
    ...
    it("pause calls setContractActiveStatus with false", async () => {
        ...
        await pauseActionFn("CAAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQC526");
        expect(repositories.setContractActiveStatus).toHaveBeenCalledWith(expect.anything(), "CAAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQC526", false);
    ...
    it("resume exits with 1 if contract is not found", async () => {
        vi.mocked(repositories.getContract).mockReturnValue(undefined);
        await resumeActionFn("CAAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQC526");
        expect(mockExit).toHaveBeenCalledWith(1);
    });
    ...
    it("resume calls setContractActiveStatus with true", async () => {
        vi.mocked(repositories.getContract).mockReturnValue({ id: "CAAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQC526" } as any);
        await resumeActionFn("CAAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQC526");
        expect(repositories.setContractActiveStatus).toHaveBeenCalledWith(expect.anything(), "CAAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQCAIBAEAQC526", true);
